    ...
    <div>
      ...
      <div className="register_contanier">
        <div class="register_form_container">
          ...
          <p style={{ padding: 30, fontSize: 10, color: "gray" }}>
            By signing up, you agree to our{" "}
            <span style={{ color: "#70e1f5", cursor: "pointer" }}>
              Terms of Use{" "}
            </span>
            and{" "}
            <span style={{ color: "#70e1f5", cursor: "pointer" }}>Privacy</span>
          </p>
          <div className="register_footer"></div>
          <p style={{ marginTop: 20, fontSize: 12 }}>
            Already have an account?
            <span>
              <Link to="/Login" className="prev_links">
                Login
              </Link>
            </span>
          </p>
